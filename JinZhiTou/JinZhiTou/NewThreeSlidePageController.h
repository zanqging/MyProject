...
@class NewThreeSlidePageController;
 ...
 */
- (NSInteger)numbersOfChildControllersInPageController:(NewThreeSlidePageController *)pageController;
 ...
 */
- (__kindof UIViewController *)pageController:(NewThreeSlidePageController *)pageController viewControllerAtIndex:(NSInteger)index;
 ...
 */
- (NSString *)pageController:(NewThreeSlidePageController *)pageController titleAtIndex:(NSInteger)index;
 ...
 */
- (void)pageController:(NewThreeSlidePageController *)pageController willCachedViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(NewThreeSlidePageController *)pageController willEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(NewThreeSlidePageController *)pageController didEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;

@end

@interface NewThreeSlidePageController : RootViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, WMPageControllerDataSource, WMPageControllerDelegate>
