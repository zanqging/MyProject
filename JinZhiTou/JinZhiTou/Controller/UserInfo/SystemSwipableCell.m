...
@interface SystemSwipableCell() <UIGestureRecognizerDelegate>
...
@implementation SystemSwipableCell
...
- (void)awakeFromNib
{
    ...
    //设置buttom背景颜色及标题颜色
    self.button1.backgroundColor = BackColor;
    ...
    self.myTextLabel.font  =SYSTEMFONT(14);
    self.myTextLabel.textColor = FONT_COLOR_BLACK;
...
- (IBAction)buttonClicked:(id)sender
{
    if (sender == self.button1) {
        [self.delegate buttonOneActionForItem:self.dic swipCell:self];
    } else if (sender == self.button2) {
        [self.delegate buttonTwoActionForItem:self.dic swipCell:self];
    } else {
