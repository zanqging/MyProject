...
@implementation SlidePageController
...
- (void)viewDidLoad {
    ...
    [self.navView.leftButton setTitle:self.leftTitle forState:UIControlStateNormal];
    [self.navView setTitle:self.titleString];
