 ...
 */
- (NSInteger)numbersOfChildControllersInPageController:(SlidePageController *)pageController;
 ...
 */
- (__kindof UIViewController *)pageController:(SlidePageController *)pageController viewControllerAtIndex:(NSInteger)index;
 ...
 */
- (NSString *)pageController:(SlidePageController *)pageController titleAtIndex:(NSInteger)index;
 ...
 */
- (void)pageController:(SlidePageController *)pageController willCachedViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(SlidePageController *)pageController willEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(SlidePageController *)pageController didEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;

@end

@interface SlidePageController : RootViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, WMPageControllerDataSource, WMPageControllerDelegate>
